    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[52%] relative flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.025] pointer-events-none"
          style={{ backgroundImage: 'linear-gradient(rgba(79,142,255,1) 1px, transparent 1px), linear-gradient(90deg, rgba(79,142,255,1) 1px, transparent 1px)', backgroundSize: '48px 48px' }} />

        {/* Animated aurora blobs */}
        <motion.div className="absolute top-1/4 left-1/3 w-80 h-80 rounded-full pointer-events-none"
          style={{ background: 'radial-gradient(circle, rgba(79,142,255,0.12) 0%, transparent 70%)', filter: 'blur(50px)' }}
          animate={{ scale: [1, 1.2, 1], opacity: [0.6, 1, 0.6] }}
          transition={{ duration: 7, repeat: Infinity, ease: 'easeInOut' }} />
        <motion.div className="absolute bottom-1/4 right-1/4 w-64 h-64 rounded-full pointer-events-none"
        ...
        <motion.div className="absolute top-2/3 left-1/4 w-48 h-48 rounded-full pointer-events-none"
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            <motion.div
              ...
              style={{ background: 'linear-gradient(135deg, #4F8EFF, #7C3AED)', boxShadow: '0 0 20px rgba(79,142,255,0.4)' }}
              animate={{ boxShadow: ['0 0 20px rgba(79,142,255,0.3)', '0 0 32px rgba(79,142,255,0.55)', '0 0 20px rgba(79,142,255,0.3)'] }}
              transition={{ duration: 2.5, repeat: Infinity }}
            >
              <Shield className="w-5 h-5 text-white" />
            </motion.div>
            <span className="text-white font-bold text-xl tracking-tight display-font">Proofly <span style={{ color: '#4F8EFF' }}>AI</span></span>
            <span className="text-[9px] font-mono border rounded px-1.5 py-0.5" style={{ color: '#4A4A60', borderColor: '#1E1E2E' }}>v3</span>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-8">
          <div>
            <motion.div
              ...
              style={{ background: 'rgba(79,142,255,0.12)', border: '1px solid rgba(79,142,255,0.3)', color: '#4F8EFF', boxShadow: '0 0 16px rgba(79,142,255,0.10)' }}
            >
              <span className="w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse inline-block" /> India&apos;s AI Fact-Checker
            </motion.div>
        ...
        <div className="relative z-10 flex gap-8">
          {[['23', 'Languages', '#4F8EFF'], ['9-Step', 'AI Pipeline', '#7C3AED'], ['<5s', 'Avg. response', '#22D3EE']].map(([v, l, c]) => (
            <motion.div key={l}
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.7 }}
            >
              <div className="text-2xl font-black display-font" style={{ color: c }}>{v}</div>

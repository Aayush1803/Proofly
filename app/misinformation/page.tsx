'use client';
// Misinformation Detection — same pipeline as the original /analyze page
// moved to /misinformation for clear dual-product separation.
          ...
          >
            ...
            >
              ...
              <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
                Our multimodal AI pipeline is dissecting your content...
              </p>
            </motion.div>

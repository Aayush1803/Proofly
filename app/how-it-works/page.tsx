...
const STEPS = [
  { number: '01', icon: FileText,      title: 'Input Collection',    subtitle: 'Text, URL, or Media',                      color: '#4F8EFF', tags: ['Text', 'URL', 'Media'],               desc: 'Submit any content you want to verify — a circulating message, a news article URL, social media post, or a video/image. Proofly accepts all three input types and auto-detects your language.' },
  ...
  { number: '04', icon: Brain,         title: 'Fact Verification',   subtitle: 'Cross-referencing trusted logic',           color: '#F59E0B', tags: ['Gemini 3', 'Verification'],         desc: 'Each claim is analyzed by the Gemini 3 Flash engine, cross-referencing internal knowledge and logical consistency against known facts from Reuters, Alt News, and WHO.' },
  ...
  { number: '06', icon: Share2,        title: 'Virality Risk',       subtitle: 'Predicting spread potential',               color: '#EF4444', tags: ['Spread analysis', 'Risk prediction'],  desc: 'Our AI analyzes emotional language, sensationalism, and clickbait factors to predict how likely false content is to spread virally across digital platforms and social networks.' },
  ...
  { number: '08', icon: MessageSquare, title: 'Counter-Message',     subtitle: 'Ready-to-share factual reply',              color: '#22D3EE', tags: ['Multilingual', 'Copy-ready'],         desc: 'Proofly generates a ready-to-share counter-message in your detected language that you can copy directly into conversations to correct misinformation within your network.' },
...
const FAQS = [
  ...
  { q: 'How accurate is Proofly?',         a: 'Powered by Google Gemini 3 Flash — an advanced multimodal reasoning engine. While highly sophisticated, AI can hallucinate. Always cross-verify critical claims with Alt News, BOOM Live, or Reuters.' },
  ...
  { q: 'Can journalists use Proofly?',     a: 'Absolutely. Proofly is designed to assist journalists, researchers, and fact-checking organisations. Contact us for newsroom API access.' },
];
